...
DROP TABLESPACE gcddata_ts INCLUDING CONTENTS;
...
DROP TABLESPACE gcdtemp_ts INCLUDING CONTENTS;
...
DROP TABLESPACE os1data_ts INCLUDING CONTENTS;
...
DROP TABLESPACE os1index_ts INCLUDING CONTENTS;
...
DROP TABLESPACE pedata_ts INCLUDING CONTENTS;
...
/* ------------------------------------------------------------------- */
/* Create the Data Tablesapce */
DROP TABLESPACE nexusdata_ts INCLUDING CONTENTS;
...
/* Create the Temp Tablesapce */
DROP TABLESPACE nexustemp_ts INCLUDING CONTENTS;
